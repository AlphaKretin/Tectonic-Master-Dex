...
# Category
def parse_category(move_text):
    type_match = re.search(r"^Category = (.+)", move_text, re.MULTILINE)
    if type_match:
...
with open("../data/moves_rr.json", "w", encoding="utf8") as outfile:
